...
self.toolbox.options.cache = {
  name: 'wlc-connect-cache-201803141951'
};
...
const db = new PouchDB('wlc-connect');
const remotedb = new PouchDB('https://admin:8eda208157d4@couchdb-bfef4c.smileupps.com/wlc-connect');
